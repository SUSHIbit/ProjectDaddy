...
<head>
    ...
    <style>
        ...
        /* Ensure smooth transitions for nav highlighting */
        .nav-link-highlight {
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="mb-4 md:mb-0">
                        <h3 class="text-xl font-bold">{{ config('app.name', 'GM Portfolio') }}</h3>
                        <p class="text-gray-400">General Manager Portfolio Website</p>
                    </div>
                ...
                <div class="mt-8 border-t border-gray-700 pt-4 text-center text-sm text-gray-400">
                    &copy; {{ date('Y') }} {{ config('app.name', 'GM Portfolio') }}. All rights reserved.
                </div>
            </div>
        </footer>
    </div>
